...
COPY misc/Caddyfile /etc/Caddyfile
RUN cp /app/public/wp-config-docker.php /app/public/wp-config.php
COPY misc/blog.php /app/public/blog.php
COPY misc/index.php /app/public/index.php
